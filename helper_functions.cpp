...
// std::vector<std::string> getStr( std::string inp) {
//     std::vector<std::string> result;
//     size_t startPos = inp.find("$$");

//     while (startPos != std::string::npos) {
//         size_t endPos = inp.find("$$", startPos + 2); 
//         if (endPos != std::string::npos) {
//             std::string extracted = inp.substr(startPos + 2, endPos - startPos - 2);
//             result.push_back(extracted);
//             startPos = inp.find("$$", endPos + 2); 
//         } else {
//             break;
//         }
//     }
...
// std::vector<bool> containsDot( std::vector<std::string> inp) {
//     std::vector<bool> result;

//     for (std::string& str : inp) {
//         bool hasDot = false;
//         for (char ch : str) {
//             if (ch == '.') {
//                 hasDot = true;
...
//         return std::make_pair(beforeDot, afterDot);
//     } 
//     else {
